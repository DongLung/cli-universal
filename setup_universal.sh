...
# Description: Configures Python and Node.js runtime versions at container startup
# Usage: Called automatically by entrypoint.sh during container initialization
# Environment: CODEX_ENV_PYTHON_VERSION, CODEX_ENV_NODE_VERSION (optional version overrides)
#
